...
""",
    ...
    async def on_enter(self) -> None:
        ...
        await self.session.generate_reply(
            instructions="Switched to Learn mode. Which concept would you like to learn about?"
        )
...
""",
    ...
    async def on_enter(self) -> None:
        ...
        await self.session.generate_reply(
            instructions="Switched to Quiz mode. Which concept would you like to be quizzed on?"
        )
...
""",
    ...
    async def on_enter(self) -> None:
        ...
        await self.session.generate_reply(
            instructions="Switched to Teach Back mode. Which concept would you like to teach me about?"
        )
